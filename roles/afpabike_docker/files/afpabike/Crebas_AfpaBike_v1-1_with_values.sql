...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mar. 08 oct. 2024 à 14:41
...
CREATE TABLE IF NOT EXISTS `reparation` (
  ...
  KEY `FK_UTILISATEUR__REPARATION` (`id_utilisateur`)
...
INSERT INTO `reparation` (`id_reparation`, `id_velo`, `id_utilisateur`, `id_typerep`, `datedebut_reparation`, `datefin_reparation`, `actif_reparation`) VALUES
(1, 1, NULL, 1, '2024-09-11 10:21:45', '2024-09-13 10:21:49', 1),
(2, 2, NULL, 2, '2024-12-09 00:00:00', '2024-09-15 10:41:10', 1),
(3, 3, NULL, 3, '2024-12-16 00:00:00', '2024-09-19 10:41:20', 1);
...
(1, 1, NULL, 1, 'Pagan', 'Jean-Jacques', 'j.pagan', 'toto', '0000-00-00', '0000-00-00', 'jean-jacques.pagan@montpellier.fr', '0605080709', '12 rue Jean Mermoz', 34500, '', '0000-00-00', '0000-00-00', 0),
(2, 4, 2, 2, 'Dupont', 'Malik', 'm.dupont1', '', '2024-06-12', '2025-02-22', 'malik.dupont@montpellier.fr', '0612345678', '4 rue des paquerettes', 34600, '', '0000-00-00', '0000-00-00', 0),
(3, 2, 4, 2, 'Allard', 'Sylvain', 's.allard1', '', '2024-06-12', '2025-02-22', 'sylvain.allard@montpellier.fr', '0695285609', '12 rue Jean Mermoz', 34500, '', '0000-00-00', '0000-00-00', 1);
