 ...
 * @version v1.0
 */
class Location_gestion_accessoire_liste	{
    ...
    */
	...
	function main()	{
		// List 'em all !!
		$obj_location_gestion_accessoire= new Location_service();
		$obj_location_gestion_accessoire->location_gestion_accessoire_liste();
		
		// Get elements for the view
		$this->resultat= $obj_location_gestion_accessoire->resultat;
		$this->VARS_HTML= $obj_location_gestion_accessoire->VARS_HTML;
		
		// kill object
		unset($obj_location_gestion_accessoire);
	}
}
