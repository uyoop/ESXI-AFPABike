...
/**
 * Class modele_marque_liste | file modele_marque_liste.php
 *
 * In this class, we show the interface "modele_marque_liste.html".
 ...
 * @subpackage modele_marque_liste
 * @author @Afpa Lab Team
 * @copyright  1920-2080 The Afpa Lab Team Group Corporation World Company
 * @version v1.0
 */
class Modele_marque_liste	{
	...
	function main()	{
		...
		$obj_modele->modele_marque_liste();
