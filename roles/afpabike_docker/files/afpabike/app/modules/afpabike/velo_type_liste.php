...
/**
 * Class velo_type_liste | file velo_type_liste.php
 *
 * In this class, we show the interface "velo_type_liste.html".
 ...
 * @subpackage velo_type_liste
 * @author @Afpa Lab Team
 * @copyright  1920-2080 The Afpa Lab Team Group Corporation World Company
 * @version v1.0
 */
class Velo_type_liste	{
